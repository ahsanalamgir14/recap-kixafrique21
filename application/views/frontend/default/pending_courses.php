<div class="row no-gutters" id = "my_courses_area">
    <?php
     foreach ($my_courses['pending']->result_array() as $my_course):
            ...
            <div class="course-box-wrap">
                    <div class="course-box">
                        ...
                        <div class="row" style="padding: 5px;">
                            ...
                            <div class="col-md-12" style="margin-bottom: 5px;">
                                 <a href="<?php echo site_url('home/lesson/'.slugify($course_details['title']).'/'.$my_course['id']); ?>" class="btn btn-block"><?php echo site_phrase('view_lessons'); ?></a>
                            </div>

                            <div class="col-md-12" style="margin-bottom: 5px;">
                                 <a href="<?php echo site_url('home/edit_course/'.$my_course['id']); ?>" class="btn btn-block"><?php echo site_phrase('edit_course'); ?></a>
                            </div>
                        </div>
                    </div>
            </div>
