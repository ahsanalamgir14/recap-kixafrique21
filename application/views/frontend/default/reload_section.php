    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th><?php echo site_phrase('lessons'); ?></th>
        ...
        <tbody>
            <?php
                ...
                <?php foreach ($sections as $section):
                    ...
                    <td>
                        <a href="#" onclick="addNameAndIdOnForm('<?php echo $section ?>', '<?php echo $section_details['title'] ?>')"><?php echo site_phrase('edit'); ?></a>
                        <a href="#" onclick="confirm_modal('<?php echo site_url('home/sections/delete/'.$course_id.'/'.$section); ?>');"><?php echo site_phrase('delete'); ?></a>
                    </td>
                </tr>
            <?php endforeach; ?>
        <?php endif; ?>
